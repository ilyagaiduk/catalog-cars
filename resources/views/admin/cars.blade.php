        ...
        <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
            <div class="mdk-drawer-layout__content page">
                ...
                <div class="container-fluid page__container">
                    ...
                    <h4 class="card-header__title mb-3">Автомобили</h4>
                   <table class="table table-responsive">
                    ...
                    @foreach($models as $brand)
                            ...
                            @foreach($brand->models as $models)
                                    @foreach($brand->cars as $cars)
                                        <tr>
                                            <td> <img src="{{ $cars->photo }}" width="50px"></td>
                                            <td> {{ $brand->name }}</td>
                                            <td> {{$models->name }}</td>
                                            <td> {{ $cars->year }}</td>
                                            <td> {{ $cars->number }}</td>
                                            ...
                                            <td> {{ $cars->price }}</td>
                                            <td> <form method="get" action="{{ route('editCar')}}">
                                                    @csrf
                                                    <input type="hidden" name="id" value="{{ $cars->id }}">
                                                    <button class="btn btn-success" type="submit">Редактировать</button>
                                                </form>
                                            </td>
                                            <td> <form method="post" action="{{ route('delete')}}">
                                                    @csrf
                                                    <input type="hidden" name="obj" value="car">
                                                    <input type="hidden" name="id" value="{{ $cars->id }}">

        ...
        <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
            <div class="mdk-drawer-layout__content page">
                ...
                <div class="container-fluid page__container">
                    ...
                    <h4 class="card-header__title mb-3">Отредактировать модель с id {{$id}}</h4>


                    <form method="post" action="{{ route('editModel')}}">
                        @csrf
                        <input type="hidden" name="id" value="{{ $id }}">
                        <label for="nameModelEdit">Введите новое имя модели</label>
                        <input type="text" name="name" id="nameModelEdit">
                        <select>
                            <option>Audi</option>

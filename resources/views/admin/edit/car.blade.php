                    ...
                    <div class="d-flex sidebar-account flex-shrink-0 mr-auto mr-lg-0">
                        <a href="index.html" class="flex d-flex align-items-center text-underline-0">
                            ...
                            <span class="flex d-flex flex-column text-white">
                                    <strong class="sidebar-brand">AUto</strong>
                                </span>
                        </a>
                    </div>
        ...
        <span class="material-icons text-primary">flag</span>
                    ...
                    <div class="dropdown">
                        <a href="#account_menu" class="dropdown-toggle navbar-toggler navbar-toggler-dashboard border-left d-flex align-items-center ml-navbar" data-toggle="dropdown">
                            <img src="/administrator/assets/images/avatar/demi.png" class="rounded-circle" width="32" alt="Frontted">
                        ...
                        <div id="company_menu" class="dropdown-menu dropdown-menu-right navbar-company-menu">
                            <div class="dropdown-item d-flex align-items-center py-2 navbar-company-info py-3">
                                    ...
                                    <span class="mr-3">
                                        <img src="/administrator/assets/images/frontted-logo-blue.svg" width="43" height="43" alt="avatar">
                                    </span>
            ...
            <div class="mdk-drawer-layout__content page">
                ...
                <div class="container-fluid page__heading-container">
                    <div class="page__heading d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-lg-between text-center text-lg-left">
                        <h1 class="m-lg-0">Каталог автомобилей</h1>
                        <div>
                ...
                <div class="container-fluid page__container">
                    ...
                    <h4 class="card-header__title mb-3">Отредактировать автомобиль с id {{$id}}</h4>


                    <form method="post" action="{{ route('editCar')}}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" value="{{ $id }}">
                        <label for="nameModelEdit">Выберите имя модели</label>
                        <select name="model" id="nameModelEdit">
                            @foreach($models as $value)
                            <option>{{$value->name}}</option>
                            @endforeach
                        </select>
                        <label for="nameModelEdit">Загрузите новое фото</label>
                        <input id="namePhotoEdit" class="btn-sm btn-primary mb-2" type="file" name="image">
                        <label for="nameYearEdit">Введите год выпуска</label>
                        <input type="number" name="year" id="nameYearEdit" min="1995" max="2021">
                        <label for="nameColorEdit">Введите новый цвет</label>
                        <input type="text" name="color" id="nameColorEdit">
                        <label for="nameTransmissionEdit">Выберите коробку передач</label>
                        <select name="transmission" id="nameTransmissionEdit">
                            @foreach($cars as $value)
                                <option>{{$value->transmission}}</option>
                            @endforeach
                        </select>
                        <label for="nameYearEdit">Введите цену аренды</label>
                        <input type="number" name="price" id="namePriceEdit" min="400" max="1000">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="avatar-group mt-2">
                                                ...
                                                <div class="avatar avatar-xs">
                                                    <img src="/administrator/assets/images/256_joao-silas-636453-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                                </div>

                                                <div class="avatar avatar-xs">
                                                    <img src="/administrator/assets/images/256_jeremy-banks-798787-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                                </div>

                                                <div class="avatar avatar-xs">
                                                    <img src="/administrator/assets/images/256_daniel-gaffey-1060698-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="avatar-group mt-2">
                                                ...
                                                <div class="avatar avatar-xs">
                                                    <img src="/administrator/assets/images/256_rsz_1andy-lee-642320-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                                </div>

                                                <div class="avatar avatar-xs">
                                                    <img src="/administrator/assets/images/256_michael-dam-258165-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                                </div>

                                                <div class="avatar avatar-xs">
                                                    <img src="/administrator/assets/images/256_luke-porter-261779-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                                </div>

                                                <div class="avatar avatar-xs">
                                                    <img src="/administrator/assets/images/stories/256_rsz_clem-onojeghuo-193397-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                                </div>
...
'mini': 'mini-student-dashboard.html'
                ...
                <!-- Bootstrap -->
                <script src="/administrator/assets/vendor/popper.min.js"></script>
                <script src="/administrator/assets/vendor/bootstrap.min.js"></script>

                <!-- Perfect Scrollbar -->
                <script src="/administrator/assets/vendor/perfect-scrollbar.min.js"></script>

                <!-- DOM Factory -->
                <script src="/administrator/assets/vendor/dom-factory.js"></script>

                <!-- MDK -->
                <script src="/administrator/assets/vendor/material-design-kit.js"></script>

                <!-- Range Slider -->
                <script src="/administrator/assets/vendor/ion.rangeSlider.min.js"></script>
                <script src="/administrator/assets/js/ion-rangeslider.js"></script>

                <!-- App -->
                <script src="/administrator/assets/js/toggle-check-all.js"></script>
                <script src="/administrator/assets/js/check-selected-row.js"></script>
                <script src="/administrator/assets/js/dropdown.js"></script>
                <script src="/administrator/assets/js/sidebar-mini.js"></script>
                <script src="/administrator/assets/js/app.js"></script>

                <!-- App Settings (safe to remove) -->
                <script src="/administrator/assets/js/app-settings.js"></script>

        ...
        <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
            <div class="mdk-drawer-layout__content page">
                ...
                <div class="container-fluid page__container">
                    ...
                    <h4 class="card-header__title mb-3">Отредактировать бренд с id {{$id}}</h4>


                                    <form method="post" action="{{ route('editBrand')}}">
                                        @csrf
                                        <input type="hidden" name="id" value="{{ $id }}">
                                        <label for="nameBrandEdit">Введите новое имя бренда</label>
                                       <input type="text" name="name" id="nameBrandEdit">
